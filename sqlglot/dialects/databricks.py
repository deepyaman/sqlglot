...
class Databricks(Spark):
    ...
    # Inherits Spark's strict TIME_MAPPING; the inverse overrides aren't inherited because
    # the metaclass recomputes INVERSE_TIME_MAPPING from each class's __dict__.
